package com.dleon.carrental.agent.agent;

import com.dleon.carrental.agent.guardrail.PromptInjectionGuard;
...
import static com.dleon.carrental.agent.constants.Constants.CAR_SUPPORT_SYSTEM_PROMPT_TEMPLATE;
...
public class SupportAgent {
  ...
  public SupportAgent(ChatClient chatClient, ChatMemory chatMemory,
