...
import com.dleon.carrental.agent.agent.SupportAgent;
import com.dleon.carrental.agent.guardrail.PromptInjectionBlockedException;
...
@Component
public class SupportAgentWebSocketHandler extends TextWebSocketHandler {

  private static final Logger log = LoggerFactory.getLogger(SupportAgentWebSocketHandler.class);
  ...
  public SupportAgentWebSocketHandler(SupportAgent supportAgent) {
  ...
  protected void handleTextMessage(WebSocketSession session, TextMessage message) {
    ...
    try {
      supportAgent.chatStream(session.getId(), userMessage)
          .subscribe(
