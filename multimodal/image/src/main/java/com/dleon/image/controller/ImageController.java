...
import com.dleon.image.dto.ImageUrlResponse;
...
@Tag(name = "Image Generation", description = "Image generation using Spring AI and OpenAI")
public class ImageController {
  ...
  public ImageUrlResponse generateUrl(@RequestParam @NotBlank(message = "prompt must not be blank") String prompt) {
  ...
  public byte[] generatePng(@RequestParam @NotBlank(message = "prompt must not be blank") String prompt) {
